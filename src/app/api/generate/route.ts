  ...
  try {
    ...
    const { object: cvData } = await generateObject({
      ...
      prompt: [
        ...
        "",
        "Contrainte impérative : le document final doit tenir sur une seule page A4.",
        "Respecte donc strictement les limites du schéma (nombre d'expériences, de lignes de",
        "description, de formations, d'outils) et privilégie la concision : phrases courtes,",
        "sans répétition. Si le CV source contient plus d'expériences ou de détails que les limites",
        "autorisées, garde uniquement les plus récentes et les plus pertinentes par rapport à",
        "l'accroche du poste, et condense ou fusionne le reste plutôt que de tout lister.",
        "",
        "Contenu brut du CV :",
        "---",
        sourceText,
